/* ============================================================
   Lo que corre en la PÁGINA para que la PWA funcione:
     1. registrar el service worker
     2. el botón "Instalar app"
     3. el aviso de "Sin conexión"
   ============================================================ */
...
// El navegador dispara este evento cuando la app cumple los requisitos
// de instalación (manifest válido + service worker + HTTPS o localhost).
